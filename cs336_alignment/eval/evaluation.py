...
def load_MATH(data_path="./data/MATH/test"):
    """
    ...
    for json_file in tqdm(json_files, desc="Loading MATH data"):
        try:
            with open(json_file, 'r', encoding='utf-8') as f:
                ...
                if 'problem' in data and 'solution' in data:
                    ...
                    print(f"Warning: Missing 'problem' or 'solution' in {json_file}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--MATH_data_path", type=str, default="./data/MATH/test")
    parser.add_argument("--prompt_template_path", type=str, default="cs336_alignment/prompts/r1_zero.prompt")
    parser.add_argument("--save_dir", type=str, default=None, help="Directory to save evaluation results and analysis")
